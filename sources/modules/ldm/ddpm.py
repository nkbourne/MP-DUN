...
from .util2 import make_beta_schedule, extract_into_tensor
...
class DDPM(nn.Module):
    ...
    def p_sample(self, x, t, c,clip_denoised=True):
        ...
        model_mean, _, _, predicted_noise = self.p_mean_variance(x=x, t=t, c=c,clip_denoised=clip_denoised)
